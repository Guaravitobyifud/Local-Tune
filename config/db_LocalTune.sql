...
CREATE TABLE tb_img (
     ...
     CONSTRAINT fk_user FOREIGN KEY (cd_user) REFERENCES tb_usuario(cd_usuario)
);
...
-- Inserir usuários
INSERT INTO tb_usuario (nm_email, cd_regsLegal, cd_tipoUsuario, nm_usuario, nm_cidade, cd_endereco, cd_contato, cd_senha) VALUES 
('curstcoba050494@gmail.com', 1, 2, 'Curst Coba','São Vicente', null, 1, '$2a$10$zF.HklYT1cV9W57gvKGI2.HPoDJDuGbO.Z/34lu9cZ5SukXY1R5GG'), -- senha123
('aratuca.entrprise@outlook.com', 2, 3, 'Araras e tucanos','São Vicente', 1, 2, '$2a$10$/dDa2FY64XbBukJidCuunuW1ltCRjRfE0NGQaePPKI3n5rJjX8UWa'), -- senha456
('meusambaminhavida123@hotmail.com', 3, 1, 'AdorSamba1213','São Vicente', null, 3, '$10$FPxFrum4/Sdoa1Pz/yfYv.6ND1IjAx2dkiSuJOzKxLZtDfysS8bIS'), -- senha789
('sebastian@gmail.com', 4, 2, 'Jazztian','São Vicente', null, 4, '$2a$10$MtuQrSod9cjs0dOvqjajR.Zyvi26T8emQJiaSy/DqQOftd5u50RYa'), -- senha101
('escapeidoasilo456@gmail.com', 5, 3, 'Casa de Repouso','São Vicente', 2, 5, '$2a$10$W9cBlXYp/AtGstvCckEj0eRP19GINalNgyL3rqQvKqj2TmYlvtmWe'), -- senha112
('marseelo@gmail.com', 6, 1, 'Guaraviton','São Vicente', null, 6, '$2a$10$Ni4Ew2F88K4ChJh85Y4ii.oKjEdsRVMaGO7u52b6Ug4CPqWRiYhEO'), -- pãodequeijomtbom
('chicobuarquemeuamor@gmail.com', 7, 1, 'RodrigoMPB','Santos', null, 7, '$2a$10$jubJ0nmtpnV1zp3MN3jNSe46KtodgPvgTewk0ppHT3ttWRKV9lf2e'), -- mpb>vida
('eusoudorocknroll@gmail.com', 8, 2, 'velvetime','Santos', null, 8, '$10$ZTA0iWrJETbyvDn3rAlHAuL7tP9EwQ9kimpOdUFia1Xa5megBb.La'), -- missperfection
('multiestilosbrasil@etec.sp.gov.br', 9, 4, 'MultiEstilosBrasil','Santos', null, 1, 'TudoTem456'); -- TudoTem456
